...
stochastic simulation and network analysis methods in Python. Raw data
cleaning and processing in SQL and Python. Report and presentation
writing using Quarto and \LaTeX. Organised seminars for the
