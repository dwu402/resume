...
% \begin{tabular}{p{8.2\spacebox}}
    \item \textbf{D. Wu}, H. Petousis-Harris, J. Paynter, V. Suresh, O. J. Maclaren, ``Likelihood-based estimation and prediction for misspecified epidemic models: an application to measles in Samoa,'' arXiv:2103.16058 [q-bio], Nov. 2021. (submitted to journal)
% \end{tabular}
\end{enumerate}
